...
<div>
    <form method="POST"
        ...
        <div class="st-form-row st-form-field--mb-12">
            <div class="st-form-field">
                ...
                <div id="photo_capture_container">
                    <div id="photo_initial_state"
                        class="st-border st-border-dashed st-rounded-6 st-p-16 st-bg-slate-50 st-text-center">
                        ...
                        <div class="st-flex st-justify-center st-gap-8">
                            ...
                            <button type="button" id="btn_upload_photo" class="st-btn st-btn--secondary st-btn--sm"
                    ...
                    <div id="photo_camera_view"
                        class="st-hidden-soft st-mt-8 st-border st-rounded-8 st-p-8 st-bg-slate-50">
                        <div class="st-flex st-align-center st-gap-8 st-justify-between st-mb-8">
                            ...
                            <button type="button" id="btn_close_camera"
                                class="st-btn st-btn--secondary st-btn--xs st-btn--pad-sm" title="Close Camera">
                                <i class="fas fa-times"></i>
                            </button>
                        </div>
                        <video id="photo_video_stream" class="st-w-full st-rounded-6 st-bg-black" autoplay muted
                            playsinline style="max-height: 300px; object-fit: contain; background: #000;"></video>
                    ...
                    <div id="photo_preview_state"
                        class="st-hidden-soft st-mt-8 st-border st-border-dashed st-rounded-6 st-p-16 st-bg-slate-50 st-text-center">
                        <div id="photo_preview_grid" class="st-flex st-flex-wrap st-gap-8 st-mb-12 st-justify-center">
                        </div>
                        <div class="st-text--sm st-text--muted st-mb-8"><span id="photo_count">0</span>/5 photos
                            selected</div>
                        <div class="st-flex st-justify-center st-gap-8">
        ...
        <div class="st-form-actions">
            ...
            <button type="button" class="st-btn st-btn--outline-primary"
                onclick="closeGlobalAjaxModal()">Cancel</button>
        </div>
    </form>
</div>

...
<head>
    <meta charset="UTF-8">
    <title>[{{ config('app.name', 'e-DCS') }}] {{ $subjectPrefix }} - {{ $slot->ticket_number }}</title>
</head>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 12px rgba(15,23,42,0.12);">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td style="padding-top:12px;">
                                    <div style="font-size:18px;font-weight:600;">{{ $subjectPrefix }}</div>
                ...
                <tr>
                    <td style="padding:24px;">
                        <p style="margin:0 0 16px 0;color:#374151;">{{ $messageLine }}</p>
                            ...
                            <tr>
                                <td style="padding:12px;background-color:#f8fafc;border-radius:8px;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="padding:4px 0;font-size:14px;"><strong>Gate:</strong> {{ $gateName }}</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:4px 0;font-size:14px;"><strong>Direction:</strong> {{ ucfirst($slot->direction) }}</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="padding:16px 0;">
                                    <a href="{{ route('vendor.bookings.show', $targetId) }}"
                            ...
                            <tr>
                                <td align="center" style="padding:0 0 16px 0;">
                                    <p style="margin:0;color:#6b7280;font-size:12px;font-style:italic;">
                                        If you're having trouble clicking the "View Booking Details" button, copy and paste the URL below into your web browser:
                                    </p>
                                    <p style="margin:8px 0 0 0;color:#374151;font-size:12px;font-family:monospace;background-color:#f1f5f9;padding:8px;border-radius:4px;word-break:break-all;">
                                        {{ route('vendor.bookings.show', $targetId) }}
                                    </p>
                                </td>
                            </tr>
                        </table>

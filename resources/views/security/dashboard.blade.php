...
<style>
/* ═══════════════════════════════════════════════════
   Security Dashboard v4 — Polished & Responsive
   ═══════════════════════════════════════════════════ */
:root {
    --sec-indigo: #5c6bc0;
...
.sec-date-label {
    ...
    padding: 7px 14px; font-size: 13px; font-weight: 600; color: #1a1a2e;
...
.sec-slot__late-tag {
    ...
    color: #d32f2f; animation: sec-blink 1.5s infinite;
}
@keyframes sec-blink { 0%,100% { opacity:1; } 50% { opacity:.4; } }

/* Arrival button on scheduled slots */
.sec-slot__arrival-btn {
    ...
    transition: all .15s; box-shadow: 0 2px 8px rgba(0,172,193,.3);
    min-width: 56px;
}
...
.sec-scan-bar {
    ...
    left: var(--st-sidebar-width, 64px); right: 0;
    z-index: 100;
    background: linear-gradient(180deg, rgba(255,255,255,0) 0%, #fff 18%);
    padding: 16px 16px 12px;
}
.sec-scan-bar__form { max-width: 580px; margin: 0 auto; }
...
.sec-scan-bar__input-group:focus-within {
    ...
    box-shadow: 0 6px 24px rgba(92,107,192,.18);
}
.sec-scan-bar__icon-left { padding: 0 0 0 14px; color: #9e9e9e; font-size: 16px; }
.sec-scan-bar__input {
    flex: 1; border: none; background: transparent;
    padding: 12px 10px; font-size: 14px; font-weight: 600;
    color: #1a1a2e; outline: none; letter-spacing: .4px; min-width: 0;
}
...
.sec-scan-bar__cam-btn {
    ...
    color: var(--sec-indigo); font-size: 18px; transition: color .15s;
}
.sec-scan-bar__cam-btn:hover { color: var(--sec-indigo-dark); }
.sec-scan-bar__submit {
    flex-shrink: 0; border: none;
    background: linear-gradient(135deg, var(--sec-indigo), var(--sec-indigo-dark));
    color: #fff; padding: 12px 18px; cursor: pointer;
    font-size: 16px; transition: opacity .15s;
}
.sec-scan-bar__submit:hover { opacity: .9; }
...
.sec-camera-panel {
    ...
    overflow: hidden; width: 340px; max-width: 92vw;
...
.sec-camera-panel__header {
    ...
    color: #1a1a2e; border-bottom: 1px solid #eee;
}
.sec-camera-panel__close {
    background: none; border: none;
    font-size: 18px; cursor: pointer; color: #999; padding: 4px;
}
...
.sec-result-card__header {
    ...
    color: #fff; background: linear-gradient(135deg, #43a047, var(--sec-green-dark));
}
...
.sec-result-card__actions {
    ...
    gap: 6px; border-top: 1px solid #f0f0f0;
}
...
.sec-btn--confirm {
    background: linear-gradient(135deg, #43a047, var(--sec-green-dark));
    color: #fff; box-shadow: 0 4px 12px rgba(67,160,71,.3);
}
...
@media (max-width: 768px) {
    .sec-scan-bar { left: 0; padding: 10px 10px 8px; }
    .sec-header__top { gap: 6px; }
    .sec-stats { gap: 4px; }
    .sec-stat { min-width: 60px; padding: 8px 4px; border-radius: 8px; }
    .sec-stat__val { font-size: 17px; }
    .sec-stat__lbl { font-size: 8px; }
    .sec-slot { padding: 10px 10px; gap: 8px; border-radius: 10px; }
    ...
    .sec-scan-bar__input { padding: 10px 8px; font-size: 13px; }
    .sec-scan-bar__submit { padding: 10px 14px; }
    .sec-result-card { border-radius: 14px; }
}

/* Phone (≤ 480px) */
@media (max-width: 480px) {
    .sec-header__top { flex-direction: column; align-items: stretch; gap: 6px; }
    ...
    .sec-date-label { font-size: 12px; padding: 6px 10px; }
    .sec-date-nav { width: 32px; height: 32px; font-size: 12px; }
    ...
    .sec-scan-bar { padding: 8px 8px 6px; }
    .sec-scan-bar__input-group { border-radius: 12px; }
    .sec-scan-bar__icon-left { padding-left: 10px; font-size: 14px; }
    .sec-scan-bar__input { font-size: 13px; padding: 10px 6px; }
    .sec-scan-bar__cam-btn { font-size: 16px; padding: 8px; }
    .sec-scan-bar__submit { padding: 10px 14px; font-size: 15px; }
    .sec-schedule { padding-bottom: 70px; }

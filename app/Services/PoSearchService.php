            ...
            try {
                ...
                if ($poDetail) {
                    $results[] = [
                        ...
                        'direction' => 'inbound', // Default for PO is inbound
                        'source' => 'sap'
                    ];
                }
            } catch (\Exception $e) {
                // Silent fail on SAP error, continue to local
            }
        }

        // 2. Return strict SAP results
        // Local DB search fallback is completely removed as per request.
        return $results;
    }

...
class TruckTypeDurationUpdateRequest extends FormRequest
{
    /**
    ...
    {
        $truckTypeDurationId = $this->route('truckTypeDurationId');
        ...
        return [
            'truck_type' => [
                ...
                'string',
                'max:100',
                Rule::unique('truck_type_durations', 'truck_type')->ignore($truckTypeDurationId)
            ],

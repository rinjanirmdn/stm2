...
class DashboardController extends Controller
{
    ...
    private function buildDashboardData(Request $request): array
    {
        ...
        return [
            ...
            'cancelledPlanned' => $rangeStats['cancelled_planned'],
            'cancelledUnplanned' => $rangeStats['cancelled_unplanned'],
            'activeRange' => $rangeStats['active'],
            'activePlanned' => $rangeStats['active_planned'],
            'activeUnplanned' => $rangeStats['active_unplanned'],
            'pendingRange' => $rangeStats['pending'],
            'scheduledRange' => $rangeStats['scheduled'],
            'waitingRange' => $rangeStats['waiting'],
            'waitingPlanned' => $rangeStats['waiting_planned'],
            'waitingUnplanned' => $rangeStats['waiting_unplanned'],
            'completedStatusRange' => $rangeStats['completed'],
            'completedPlanned' => $rangeStats['completed_planned'],
            'completedUnplanned' => $rangeStats['completed_unplanned'],
    ...
    /**
     * Get unique vendor/customer names from slots and booking_requests
     */
    private function getVendorList(): array
    {
        $slotVendors = DB::table('slots')
        ...
        $bookingVendors = DB::table('booking_requests')
        ...
        $merged = array_values(array_unique(array_merge($slotVendors, $bookingVendors)));
